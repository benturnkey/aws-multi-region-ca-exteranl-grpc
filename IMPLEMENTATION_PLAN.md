...
Not implemented yet:
- Mutating nodegroup RPCs (`NodeGroupIncreaseSize`, `NodeGroupDecreaseTargetSize`, `NodeGroupDeleteNodes`, `NodeGroupTargetSize`).
- Node template/options RPCs (`NodeGroupTemplateNodeInfo`, `NodeGroupGetOptions`).
...
- [ ] Implement `NodeGroupIncreaseSize`, `NodeGroupDecreaseTargetSize`, `NodeGroupDeleteNodes`, `NodeGroupTargetSize`.
- [ ] Add region-aware routing tests and id parsing tests.

### Phase 3: Template and Options
- [ ] Implement `NodeGroupTemplateNodeInfo` and `NodeGroupGetOptions`.
